...
function addTodo() {
  ...
  saveTodos();   // 그리고 localStorage에도 저장해줘야 하니까 saveTodos() 함수호출
...
// '추가' 버튼 클릭 이벤트
addBtn.addEventListener('click', addTodo);  // button 태크에 onclick 속성입니다. -> 두 번째 argument로 addTodo 함수를 넣었는데, addTodo()가 아니라는 점에도 주목해야한다고 했습니다.
